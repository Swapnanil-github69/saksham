...
// Top-Left: Pipeline progress card
export const PipelineCard = () => (
  <div className="floating-card pipeline-card">
    ...
    {/* 4-Step Pipeline Stepper (matching Job Portal Application Lifecycle) */}
...
// Left: Cursor tag for Alex Jhordan (Candidate)
...
// Top-Right: Cursor tag for Malik Grotesk (Recruiter)
...
// Mid-Right: Candidate match chat card for Natalie Monet
...
// Central Showcase Card: Candidate Details Modal
...
// Sector Breakdown Donut Chart Card
